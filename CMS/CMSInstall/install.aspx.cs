...
public partial class CMSInstall_install : CMSPage, ICallbackEventHandler
{
    ...
    /// </summary>
    private const string HELP_TOPIC_LINK = "MJRP";


    /// <summary>
    /// Short link to help topic page regarding disk permissions.
    /// </summary>
    private const string HELP_TOPIC_DISK_PERMISSIONS_LINK = "DwAU";
    ...
    private void wzdInstaller_ActiveStepChanged(object sender, EventArgs e)
    {
        switch (wzdInstaller.ActiveStepIndex)
        {
            ...
            case 7:
                ...
                LocalizationContext.PreferredCultureCode = SettingsKeyInfoProvider.GetStringValue(SiteName + ".CMSDefaultCultureCode");
