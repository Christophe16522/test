...
public class SearchIndexListControlExtender : ControlExtender<UniGrid>
{
    ...
    public override void OnInit()
    {
        ...
        string indexPath = Path.Combine(SystemContext.WebApplicationPhysicalPath, "App_Data\\CMSModules\\SmartSearch\\");
    ...
    object Control_OnExternalDataBound(object sender, string sourceName, object parameter)
    {
        switch (sourceName.ToLowerCSafe())
        {
            ...
            case "indexstatus":
                ...
                if (sii != null)
                {
                    return Control.GetString("srch.status." + sii.IndexStatus.ToString());
                }
                break;
