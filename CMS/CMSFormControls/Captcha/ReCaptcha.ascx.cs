...
public partial class CMSFormControls_Captcha_ReCaptcha : FormEngineUserControl
{
    ...
    public string PublicKey
    {
        get
        {
            ...
            {
                mPublicKey = SettingsKeyInfoProvider.GetStringValue("CMSReCaptchaPublicKey");
            }
    ...
    public string PrivateKey
    {
        get
        {
            ...
            {
                mPrivateKey = SettingsKeyInfoProvider.GetStringValue("CMSReCaptchaPrivateKey");
            }
...
$j(document).ready(function () {
    ...
    if((Recaptcha != null) && (Recaptcha.old_finish_reload == null)) {       
        ...
        Recaptcha.finish_reload = function(a, b, c, d) {
            ...
            $j('div[id=\""recaptcha_widget_div\""]').each(function(index) {
                if(index > 0) {
                    $j(this).parent().html($j('#recaptcha_widget_div').clone(true, true));
                }
            });
        }
    }
    ...
    if (typeof Sys != 'undefined') {
        ...
        requestManager.add_endRequest(function(sender, args) {
            if(Recaptcha != null) {
                ...
                if ((Recaptcha.widget == null) || !document.getElementById('recaptcha_widget_div')) {
                    $j('#cbCaptcha').show().html('<div id=""recaptcha_widget_div"" style=""display:none""></div>');
        ...
        {
            script = "$j(document).ready(function() { $j('#" + pnlCaptchaWrap.ClientID + "').html($j('#recaptcha_widget_div').clone(true, true));})";
