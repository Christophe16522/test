...
function SetResource(hdnValId, resKey, textBoxId, textBoxValue, btnLocalizeFieldId, btnLocalizeStringId, btnRemoveLocalizationId, localizedContainerId) {
    ...
    jQuery('#' + localizedContainerId).addClass('", TEXT_BOX_LOCALIZED_CSS, @"').trigger('checkScrollbar');
    
    jQuery('#' + btnLocalizeFieldId).hide();
    jQuery('#' + btnLocalizeStringId).css('display', 'inline');
    jQuery('#' + btnRemoveLocalizationId).css('display', 'inline');
    return false;
}
...
function SetTranslation(textBoxId, textBoxValue, hdnValId, resKey) {
    ...
    jQuery('#' + hdnValId).val('", MACRO_START, @"' + resKey + '", MACRO_END, @"');
}
...
function RemoveLocalization(hdnValId, textBoxId, btnLocalizeFieldId, btnLocalizeStringId, btnRemoveLocalizationId, localizedContainerId) {
    if (confirm(" + ScriptHelper.GetLocalizedString("localizable.removelocalization") + @")) {
        ...
        jQuery('#' + localizedContainerId).removeClass('", TEXT_BOX_LOCALIZED_CSS, @"');
        jQuery('#' + btnLocalizeStringId).hide();
        jQuery('#' + btnRemoveLocalizationId).hide();
        jQuery('#' + btnLocalizeFieldId).css('display', 'inline');
    }
    return false;
}");
