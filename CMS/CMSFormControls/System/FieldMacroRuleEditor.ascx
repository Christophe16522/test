    ...
    <ContentTemplate>
        ...
        <div class="form-horizontal">
            <div class="form-group">
                <cms:LocalizedLabel ID="lblErrorMsg" CssClass="control-label" runat="server" ResourceString="general.errormessage" EnableViewState="false" DisplayColon="true" AssociatedControlID="tE" />
