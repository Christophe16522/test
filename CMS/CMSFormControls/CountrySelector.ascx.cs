...
public partial class CMSFormControls_CountrySelector : FormEngineUserControl
{
    ...
    private bool? mAddAllItemsRecord = null;
    private bool? mAddNoneRecord = null;
    private bool mUseCodeNameForSelection = true;
    private bool? mAddSelectCountryRecord = null;
    private bool? mEnableStateSelection = null;
    ...
    public override object Value
    {
        ...
        set
        {
            ...
            if (returnWhat == ReturnType.CountryID)
            {
                ...
                if (Form != null && Form.Data != null && Form.Data.ContainsColumn(StateIDColumnName))
                {
                    StateInfo stateInfo = StateInfoProvider.GetStateInfo(ValidationHelper.GetInteger(Form.Data.GetValue(StateIDColumnName), 0));
