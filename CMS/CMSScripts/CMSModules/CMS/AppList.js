define(['CMS/Filter', 'CMS/EventHub', 'CMS/CheckChanges', 'jQueryJScrollPane', 'Underscore', 'CMS/Loader'], function (Filter, EventHub, checkChanges) {
    'use strict';
    ...
    var $ = window.jQuery,
        ...
        hide = function () {
            $appListOverLayer.animate({ opacity: '0.0' }, { duration: data.duration, queue: false });
        ...
        setWindowLocation = checkChanges(function (w, newLocationKey, newLocationValue, successCallback) {
    ...
    AppList = function (serverData) {
        ...
        // Subscribe to event so another modules can open applist
        EventHub.subscribe('ShowApplicationList', function () {
            show();
        });
