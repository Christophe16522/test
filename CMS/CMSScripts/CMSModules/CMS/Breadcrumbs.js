 ...
 */
define(['CMS/EventHub', 'CMS/UrlHelper', 'CMS/CheckChanges', 'Underscore'], function (hub, urlhelper, checkChanges) {
    'use strict';

    var _ = window._,
        $ = window.jQuery,
        breadcrumbsRightSpace = 30, // Empty space after last breadcrumb
    ...
    Breadcrumbs.prototype.goBack = function (p) {
        var breadcrumbs = this.$breadcrumbs,
            ...
            $bc, i, $breadcrumbLink, breadcrumbEvents;
