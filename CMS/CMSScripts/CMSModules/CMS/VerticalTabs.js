define(['CMS/EventHub', 'CMS/Application', 'jQueryJScrollPane'], function (hub, application) {
    var $ = jQuery,
    ...
    initScrollPane = function () {
        ...
        if (jQuery('.nav-tabs-site-selector').length > 0) {
            jQuery('ul.TabControlTable').css('padding-top', 0);
        }
