define(['CMS/EventHub', 'CMS/GridActions', 'CMS/AppList'], function (eventHub, GridActions, AppList) {
    ...
    BlogsGrid.prototype.openBlogInPages = function (blogId, blogCulture) {
        if (blogId !== 0) {
            appList.openApplication(undefined, undefined, '?nodeid=' + blogId + '&culture=' + blogCulture, this.pagesApplicationHash);
        }
    };
