...
function initializeResize() {
    ...
    jQuery('.alert-dismissable').click(function () {
        resizearea();
    });
}
...
function resizeareainternal() {
    ...
    var footerHeight = $j("#divFooter").outerHeight(true);
    ...
    // Main height
    var height = document.body.clientHeight - selectorOffsetTop.top - $j("div .CopyLayoutPanel").outerHeight(true) - footerHeight - offsetValue;
...
function getItems(forceLoad) {
    if (forceLoad || (itemSelector == null)) {
        ...
        uniFlatSearchPanel = $j("div  .uni-flat-search-panel");
        uniFlatPager = $j("div .uniflat-pager");
        selectorFlatDescription = $j("div .selector-flat-description");
    }
}
