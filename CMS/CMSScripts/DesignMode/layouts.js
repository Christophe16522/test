...
function EnsureEditControls(type) {
    ...
    switch (type.toLowerCase()) {
        ...
        case "textbox":
            if (textBoxEdit == null) {
                textBoxEdit = jQuery('<input class="EditProperty form-control" type="text" />');
        ...
        default:
            if (textAreaEdit == null) {
                textAreaEdit = jQuery('<textarea wrap="off" class="EditProperty TextAreaMedium form-control"></textarea>');
