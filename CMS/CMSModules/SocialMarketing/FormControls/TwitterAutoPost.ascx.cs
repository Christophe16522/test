...
public partial class CMSModules_SocialMarketing_FormControls_TwitterAutoPost : FormEngineUserControl
{
    ...
    private TwitterPostInfo TweetInfo
    {
        get
        {
            if ((mTweetInfo == null) && (Document != null) && (Document.DocumentGUID != Guid.Empty))
            {
                mTweetInfo = TwitterPostInfoProvider.GetTwitterPostInfosByDocumentGuid(Document.DocumentGUID).ToList().FirstOrDefault(x => x.TwitterPostIsCreatedByUser);
            }
    ...
    public override bool Enabled
    {
        ...
        set
        {
            ...
            if (!value && !StopProcessing && (TweetInfo == null))
            {
    ...
    /// <summary>
    /// Indicates whether current user has read permission on tweets.
    /// </summary>
    ...
    /// <summary>
    /// Indicates whether current user has modify permission on tweets.
    /// </summary>
