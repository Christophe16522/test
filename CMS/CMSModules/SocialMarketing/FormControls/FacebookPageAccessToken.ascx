...
<script type="text/javascript">
    ...
    function fbSetAccessToken(parameters) {
        var tokenControl = jQuery('#' + parameters.tokenControlId),
            expirationControl = jQuery('#' + parameters.expirationControlId),
            pageIdControl = jQuery('#' + parameters.pageIdControlId),
            appIdControl = jQuery('#' + parameters.appIdControlId);
