...
public partial class CMSModules_Ecommerce_Pages_Tools_Products_Product_Edit_Variants : CMSProductsPage
{
    ...
    /// </summary>
    private const string HELP_TOPIC_LINK = "_oPl";
    ...
    private string CurrentWarning
    {
        get
        {
            return ValidationHelper.GetString(mWarnings["DeleteWarning_" + ctlAsync.ProcessGUID], string.Empty);
        }
        set
        {
            mWarnings["DeleteWarning_" + ctlAsync.ProcessGUID] = value;
        }
    }
    ...
    private string CurrentError
    {
        get
        {
            return ValidationHelper.GetString(mWarnings["DeleteError_" + ctlAsync.ProcessGUID], string.Empty);
        }
        set
        {
            mWarnings["DeleteError_" + ctlAsync.ProcessGUID] = value;
        }
    }
