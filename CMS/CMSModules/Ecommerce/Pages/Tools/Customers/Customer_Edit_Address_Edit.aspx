...
<asp:Content ContentPlaceHolderID="plcContent" ID="content" runat="server">
    <table style="vertical-align: top">
        ...
        <tr>
         ...
         <tr>
            <td class="FieldLabel">
                <asp:Label runat="server" ID="lblnum" EnableViewState="false" />
            </td>
            <td>
                <cms:CMSTextBox ID="txtnum" runat="server" CssClass="TextBoxField" MaxLength="100"
                    EnableViewState="false" />
            </td>
            <td>
                <cms:CMSRequiredFieldValidator ID="rqvnum" runat="server" ControlToValidate="txtnum"
                    ValidationGroup="Address" EnableViewState="false" />
            </td>
        </tr>
        <tr>
