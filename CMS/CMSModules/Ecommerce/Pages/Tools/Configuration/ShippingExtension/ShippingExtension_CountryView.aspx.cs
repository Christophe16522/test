...
[Title("Objects/Ecommerce_ShippingOption/object.png", "Shipping extension country view summary", "newgeneral_tab2")]
public partial class CMSModules_Ecommerce_Pages_Tools_Configuration_ShippingExtension_ShippingExtension_CountryView : CMSShippingOptionsPage
{
    ...
    private void OnAction(string actionName, object actionArgument)
    {
        ...
        {
            case "details":
                URLHelper.Redirect("ShippingExtension_CountryViewDetail.aspx?shippingCountryID=" + Convert.ToString(actionArgument)); 
                break;
        }
    }
