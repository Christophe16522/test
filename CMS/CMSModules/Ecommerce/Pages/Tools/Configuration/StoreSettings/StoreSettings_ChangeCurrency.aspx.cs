...
function checkRecalculation(){
  ...
  var checkBoxes = jQuery(" + "\"#recalculationDetail input[type='checkbox']\"" + @");
  ...
  if(recalcNeeded)
  {
    jQuery('#" + txtEchangeRate.ClientID + @"').parents('.form-group').show();
    jQuery('#" + txtRound.ClientID + @"').parents('.form-group').show();
  }else
  {
    jQuery('#" + txtEchangeRate.ClientID + @"').parents('.form-group').hide();
    jQuery('#" + txtRound.ClientID + @"').parents('.form-group').hide();
  }
};";
...
{
  var checkedCheckboxies = jQuery('#recalculationDetail input:checkbox:checked');
