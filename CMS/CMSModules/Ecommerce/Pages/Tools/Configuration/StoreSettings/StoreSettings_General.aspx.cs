...
public partial class CMSModules_Ecommerce_Pages_Tools_Configuration_StoreSettings_StoreSettings_General : CMSEcommerceStoreSettingsPage
{
    ...
    private void InitializeControls()
    {
        ...
        SettingsGroupViewer.Where = "CategoryName IN (N'CMS.Ecommerce.UnregisteredCustomers', N'CMS.Ecommerce.Accounts', N'CMS.Ecommerce.Shipping', N'CMS.Ecommerce.Taxes', N'CMS.Ecommerce.ProductsUI', N'CMS.Ecommerce.ProductProperties', N'CMS.ECommerce.Pages', N'CMS.Ecommerce.Pricing', N'CMS.Ecommerce.Invoice')";
