...
public partial class CMSModules_Ecommerce_Pages_Tools_Configuration_ShippingOptions_ShippingOption_Edit_Payment : CMSShippingOptionsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            CheckUIElementAccessHierarchical(ModuleName.ECOMMERCE, "Ecommerce.GlobalShippingOptions.PaymentMethods");
        }
        else
        {
            CheckUIElementAccessHierarchical(ModuleName.ECOMMERCE, "Configuration.ShippingOptions.PaymentMethods");
        }
        ...
        if (mShippingOptionId > 0)
        {
            ...
            if (mShippingOptionInfoObj != null)
            {
                ...
                offerGlobalPaymentMethods = editedSiteId == 0 || ECommerceSettings.AllowGlobalPaymentMethods(editedSiteId);
