        ...
        <ContentTemplate>
            <cms:UniGrid runat="server" ID="ugDiscounts" IsLiveSite="false" Columns="DiscountID, DiscountDisplayName, DiscountIsFlat, DiscountValue, DiscountSiteID, DiscountOrderAmount, DiscountValidTo, DiscountValidFrom, DiscountEnabled, DiscountOrder, DiscountApplyFurtherDiscounts, DiscountUsesCoupons"
                ...
                <GridColumns>
                    ...
                    <ug:Column Name="ValidFrom" Source="DiscountValidFrom" ExternalSourceName="#userdatetimegmt" Caption="$general.from$" Wrap="false" />
                    <ug:Column Name="ValidTo" Source="DiscountValidTo" ExternalSourceName="#userdatetimegmt" Caption="$general.to$" Wrap="false" />
                    <ug:Column Name="UsesCoupons" Source="DiscountUsesCoupons" Caption="$com.discount.couponsused$" ExternalSourceName="#yesno" Wrap="false" />
                    <ug:Column Name="Application" Source="##ALL##" Caption="$com.discount.couponapplied$" ExternalSourceName="application" Wrap="false" />
