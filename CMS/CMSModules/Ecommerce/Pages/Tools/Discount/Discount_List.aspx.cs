...
public partial class CMSModules_Ecommerce_Pages_Tools_Discount_Discount_List : CMSEcommercePage
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        switch (DiscountType)
        {
            case DiscountApplicationEnum.Products:
                ...
                ugDiscounts.NamedColumns["UsesCoupons"].Visible = false;
    ...
    /// <summary>
    /// Checks if user has permission to modify/delete discounts.
    /// </summary>
    private void CheckModifyPermission()
    {
        // Check permissions
        if (!ECommerceContext.IsUserAuthorizedToModifyDiscount())
        {
            RedirectToAccessDenied("CMS.Ecommerce", "EcommerceModify OR ModifyDiscounts");
        }
    }
