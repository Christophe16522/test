<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_Ecommerce_Controls_ShoppingCart_ShoppingCartCheckRegistrationNew"
...
<div class="BlockContent">
    <asp:Label ID="Label1" runat="server" Visible="false" CssClass="ErrorLabel" EnableViewState="false" />
        ...
        <tr>
            ...
            <td>
                <cms:ExtendedTextBox ID="txtBillingName" runat="server" CssClass="TextBoxField" MaxLength="200" /><asp:Label
                    ID="Label2" runat="server" EnableViewState="false" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                <cms:ExtendedTextBox ID="txtBillingAddr1" runat="server" CssClass="TextBoxField"
                    MaxLength="100" /><asp:Label ID="Label3" runat="server" EnableViewState="false" />
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <cms:ExtendedTextBox ID="txtBillingCity" runat="server" CssClass="TextBoxField" MaxLength="100" /><asp:Label
                    ID="Label4" runat="server" EnableViewState="false" />
            </td>
        </tr>
        <tr>
            <%--Billing ZIP--%>
            ...
            <td>
                <cms:ExtendedTextBox ID="txtBillingZip" runat="server" CssClass="TextBoxField" MaxLength="20" /><asp:Label
                    ID="Label5" runat="server" EnableViewState="false" />
            </td>
        </tr>
        <tr>
                ...
                <tr>
                    ...
                    <td>
                        <cms:ExtendedTextBox ID="txtShippingName" runat="server" CssClass="TextBoxField"
                            MaxLength="200" /><asp:Label ID="Label6" runat="server" EnableViewState="false" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <cms:ExtendedTextBox ID="txtShippingAddr1" runat="server" CssClass="TextBoxField"
                            MaxLength="100" /><asp:Label ID="Label7" runat="server" EnableViewState="false" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <cms:ExtendedTextBox ID="txtShippingZip" runat="server" CssClass="TextBoxField" MaxLength="20" /><asp:Label
                            ID="Label8" runat="server" EnableViewState="false" />
                    </td>
                </tr>
                <tr>
                    <%--Shipping country--%>
