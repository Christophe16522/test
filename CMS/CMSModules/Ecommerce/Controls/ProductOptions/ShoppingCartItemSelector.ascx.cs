...
public partial class CMSModules_Ecommerce_Controls_ProductOptions_ShoppingCartItemSelector : CMSUserControl
{
    ...
    private bool mShowPriceIncludingTax = ECommerceSettings.DisplayPriceIncludingTaxes(SiteContext.CurrentSiteName);
    ...
    #endregion
    //protected void arrowDown(object sender, ImageClickEventArgs e)
    //{
    //    if (Convert.ToInt32(txtUnits.Text) > 1)
    //    {
    //        txtUnits.Text = Convert.ToString(Convert.ToInt32(txtUnits.Text) - 1);
    //    }
    //}
    protected void arrowUp(object sender, ImageClickEventArgs e)
    {
    ...
    {
        if ((Convert.ToInt32(txtUnits.Text) > 1) && (Convert.ToInt32(txtUnits.Text) < 100))
        {
            txtUnits.Text = Convert.ToString(Convert.ToInt32(txtUnits.Text));
        }
    }
    protected void arrowDown(object sender, EventArgs e)
    {
