...
<asp:Panel ID="pnlFilter" runat="server" DefaultButton="btnFilter">
    <div class="form-horizontal form-filter">
        ...
        <asp:PlaceHolder ID="plcSubsectionProducts" runat="server">
            <div class="form-group">
                <div class="filter-form-label-cell">
                    <cms:LocalizedLabel CssClass="control-label" ID="lblShowAllChildren" runat="server"
                        EnableViewState="false" ResourceString="com.sku.fromsubsections" DisplayColon="true" AssociatedControlID="chkShowAllChildren" />
                </div>
                <div class="filter-form-value-cell">
                    <cms:CMSCheckBox ID="chkShowAllChildren" runat="server" Checked="true" />
                </div>
            </div>
        </asp:PlaceHolder>
