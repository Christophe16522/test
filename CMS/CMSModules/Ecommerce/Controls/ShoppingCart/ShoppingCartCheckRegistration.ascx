...
<div class="left_block_payement etape_2">
    <h4>
        <asp:Label ID="LabelAlreadyAccount" runat="server" Text="j'ai déjà un compte"></asp:Label></h4>
    ...
    <div class="cont_client">
        <div class="cont_post left">
            ...
            <asp:TextBox ID="txtFirstName" runat="server" CssClass="champtexte right threequarter" MaxLength="100"
                EnableViewState="false" ToolTip="Prénom" />
        ...
        <div class="cont_box_different">
            <label>
                ...
                <asp:Label ID="LabelAdresseDifference" runat="server" Text="Adresse de livraison différente de l’adresse de facturation"></asp:Label>
            </label>
            <div class="clr">
            </div>
        </div>
        ...
        <div class="cont_post  left cont_check_condition">
            ...
            <a href="#block_condition" class="fancybox_condition_utilisation">
                <asp:Label ID="LabelCondition" runat="server" Text="les Conditions Générales de Vente"></asp:Label></a>
            <div id="block_condition" style="display: none; padding: 20px">
                <%--   condition utilisation--%>
                <h1>
                    Conditions générales d&rsquo;offre et de vente</h1>
                <div>
                    de la S. P. R. L. Servranx &ndash; Éditions et laboratoires &ndash; 23-25 rue G.
                    Biot &ndash; 1050 Bruxelles &ndash; Belgique<br />
                    Tél. 00 32 26 49 18 40 &ndash; N&deg; d&rsquo;entreprise BE 0450.834.719<br />
                    &nbsp;<br />
                    &nbsp;<br />
                    <strong>1 &ndash; Droits (copyright&copy;)</strong><br />
                    Ce site est la propriété de la S.P.R.L.* Servranx en sa totalité, ainsi que l&rsquo;ensemble
                    des droits afférents. Toute reproduction, intégrale ou partielle, est systématiquement
                    soumise à l&rsquo;autorisation des propriétaires. Toutefois, les liaisons de type
                    hypertextes vers le site sont autorisées sans demandes spécifiques.<br />
                    ...
                    s&rsquo;y sont glissées, en aucun cas, la responsabilité de la S.P.R.L. Servranx
                    ne pourra être engagée.<br />
                    <strong>3 &ndash; Offres et ventes</strong><br />
                    a&nbsp;) Nos conditions d&rsquo;offre et de vente aux consommateurs sont soumises
                    à la loi du 6 avril 2010 relative aux pratiques du marché et à la protection de
                    consommateur (LPMC en abrégé) ainsi que de ses arrêtés d&rsquo;exécution, et des
                    arrêtés visés à l&rsquo;article 139 de cette loi &ndash; Voir&nbsp;:&nbsp;<a href="http://www.economie.fgov.be/">http://www.economie.fgov.be</a><br />
                    b) Cette loi précise entre autre que le consommateur&nbsp;bénéficie d&rsquo;un droit
                    de rétractation de 14 jours calendrier à partir de la réception de la marchandise
                    commandée.<br />
                    c) À tout moment de la transaction, les prix indiqués sont nets, TVA incluse, hors
                    frais d&rsquo;envoi et de paiement.<br />
                    Lors de l&rsquo;achat et de la finalisation du paiement&nbsp;:<br />
                    &ndash; Étape 1 de 6&nbsp;: prix net et TVA indiqués séparément + sous-total.<br />
                    &ndash; Étape 3 de 6&nbsp;: toute livraison hors de l&rsquo;Union européenne permet
                    de bénéficier de l&rsquo;exonération de la TVA.&nbsp;<br />
                    &ndash; Étape 5 de 6&nbsp;: récapitulation comprenant tous les montants de la facture
                    finale&nbsp;: prix de la marchandise, prix du port ainsi que les différents montants
                    de TVA applicables (6 et 21 %).<br />
                    Les frais d&rsquo;envoi sont calculés automatiquement et ajoutés à la facture. Chaque
                    modification ou ajout d&rsquo;un achat modifie le calcul des frais d&rsquo;envoi.<br />
                    d) Les commandes peuvent être modifiées ou annulées à tout moment avant la validation
                    finale faite par le consommateur.<br />
                    e)&nbsp;Les marchandises refusées en vertu du droit de rétractation du consommateur
                    doivent être retournées au vendeur avant remboursement. Elles doivent être retournées
                    au vendeur en parfait état, dans leur&nbsp;emballage d&rsquo;origine, sans la moindre
                    altération ou le moindre dommage et ne peuvent porter la moindre marque ou mention
                    autre que les indications d&rsquo;origines voulues par le propriétaire de la marque
                    au moment de leur fabrication.&nbsp;Ces marchandises ne peuvent avoir été utilisées.<br />
                    f) Le remboursement des marchandises refusées en vertu du droit de rétractation
                    du consommateur se fera au prix net indiqué sur la facture d&rsquo;achat remise
                    au consommateur. Les frais de port ne sont pas remboursés.<br />
                    g) Les coûts de remboursement (transferts de fonds, virements de toute nature, émissions
                    de chèque, etc.) sont aux frais du consommateur à l&rsquo;origine de la demande
                    dudit remboursement.<br />
                    h) Toute commande validée par le consommateur implique l&rsquo;accord entier et
                    inconditionnel du consommateur aux termes des&nbsp;<strong>conditions générales d&rsquo;offre
                        et de vente</strong>&nbsp;de la S. P. R. L. Servranx.<br />
                    <strong>4 &ndash; Commande</strong><br />
                    Les systèmes d&rsquo;enregistrement automatique sont considérés comme valant preuve
                    de la nature, du contenu et de la date de la commande. La S.P.R.L. Servranx confirme
                    la commande à l&rsquo;adresse électronique communiquée par le client. Les informations
                    énoncées par l&rsquo;acheteur lors de la prise de commande engagent celui-ci&nbsp;:
                    en cas d&rsquo;erreur dans le libellé des coordonnées du destinataire, le vendeur
                    ne saurait être tenu responsable de l&rsquo;impossibilité dans laquelle il pourrait
                    être de livrer le produit.<br />
                    <strong>5 &ndash; Disponibilité des articles</strong><br />
                    La majorité de nos produits proposés sur le site commercial sont disponibles au
                    comptoir de vente dans nos bureaux.<br />
                    <strong>6 &ndash; Livraison</strong><br />
                    La S. P. R. L. Servranx s&rsquo;engage à remettre à son transporteur toutes les
                    références commandées par l&rsquo;acheteur, et ce, dans les meilleurs délais. Ce
                    transporteur est responsable de la livraison à l&rsquo;adresse de livraison fournie
                    par l&rsquo;acheteur. De plus, en ce qui concerne les livraisons hors de l&rsquo;Union
                    européenne, le client s&rsquo;engage à régler toutes les taxes dues à l&rsquo;importation
                    de produits, droit de douane, taxe sur la valeur ajoutée, et toutes autres taxes
                    dues en vertu des lois applicables dans le pays de réception de la commande. La
                    livraison sera effectuée par La Poste en port colis normal ou prioritaire, recommandé
                    ou non, ou par UPS (United Parcel Service) standard ou Expedited (U.S.A.) suivant
                    le choix du client et selon les disponibilités vers le pays de destination.<br />
                    Tout est mis en œuvre pour que les commandes arrivent en bon état et dans les temps
                    jugés normaux. Les retards éventuels du transporteur n&rsquo;engagent pas la responsabilité
                    du vendeur et ne donnent pas droit à quelque remboursement que ce soit ni en dommages
                    ni en intérêts.<br />
                    Sont considérés comme cas de force majeure déchargeant le vendeur de son obligation
                    de livrer : la guerre, l&rsquo;émeute, l&rsquo;incendie, les grèves, les accidents
                    et l&rsquo;impossibilité d&rsquo;être approvisionnés.<br />
                    Les marchandises voyagent toujours aux risques et périls du destinataire. Celui-ci
                    doit vérifier son colis à l&rsquo;arrivée et dispose d&rsquo;un délai de 48 heures
                    pour faire d&rsquo;éventuelles réserves auprès du transporteur en cas de perte partielle
                    ou de dégradation de notre envoi. Dans les cas d&rsquo;un produit technique, le
                    client veillera particulièrement à vérifier le bon fonctionnement de l&rsquo;appareil
                    livré, à lire le mode d&rsquo;emploi fourni. En cas de défauts apparents, l&rsquo;acheteur
                    s&rsquo;engage à le signaler au vendeur dans les 4 jours ouvrables.<br />
                    Pour des raisons de disponibilité, une commande peut être livrée en plusieurs colis.
                    Le client ne règle alors qu&rsquo;une seule livraison. Si le client souhaite deux
                    lieux de livraison, il passe deux commandes, avec les frais de livraison liés.<br />
                    <strong>7 &ndash; Prix</strong><br />
                    Les prix de tous les produits s&rsquo;entendent net, en euros, toutes taxes comprises,
                    hors frais de port. Ils sont révisables à tout moment&nbsp;sans préavis. Les articles
                    sont facturés en euros sur la base des prix indiqués sur le site au moment de la
                    commande. Une facture est jointe à toute commande. Si une éventuelle disparité apparaissait
                    dans un prix, l&#39;acheteur et le vendeur auront recours à la dernière liste officielle
                    des prix publiée par la maison sur son site. Le prix définitif de la commande inclut
                    les prix nets des marchandises, TVA incluse, ainsi que le prix, TVA incluse, de
                    tous les services afférents à l&rsquo;envoi desdites marchandises, manutentions
                    et emballages inclus.<br />
                    <strong>8 &ndash; TVA</strong><br />
                    La réglementation est fixée par l&rsquo;Union européenne.<br />
                    Expédition à destination d&rsquo;un pays de l&rsquo;Union européenne&nbsp;: (pour
                    tout envoi à l&rsquo;adresse de facturation) 1) Si le destinataire n&rsquo;est pas
                    assujetti à la TVA : facturation incluant la TVA belge. 2) Si le destinataire est
                    assujetti à la TVA : facturation hors TVA belge avec vérification du numéro d&rsquo;identification
                    (TVA Intracommunautaire) du destinataire. Expédition à destination d&rsquo;un pays
                    hors de l&rsquo;Union européenne&nbsp;: facturation exonérée de la TVA belge. &nbsp;<br />
                    <strong>9 &ndash; Paiement</strong><br />
                    Les articles sont payables au moment de la commande. Le paiement s&rsquo;effectue
                    par carte de crédit, comme proposé dans le module de commande en ligne. En ligne,
                    OGONE permet de régler via un serveur bancaire du groupe Bank Card Company BCC dans
                    un environnement sécurisé. Le numéro de carte bancaire du client est dirigé vers
                    les serveurs de la banque, le règlement s&rsquo;effectue donc directement à une
                    banque dans un environnement sécurisé sans passer par le serveur de la boutique.
                    Les numéros de carte ne sont connus que du partenaire bancaire (BCC), jamais du
                    vendeur. La commande validée par le client ne sera considérée effective que lorsque
                    les centres de paiements bancaires concernés auront donné leur accord (Ogone, Paypal,
                    etc.). En cas de refus desdits centres, la commande sera automatiquement annulée
                    et le client sera prévenu par message électronique. Par ailleurs, la S.P.R.L Servranx
                    se réserve le droit de refuser toute commande d&rsquo;un client avec lequel il existerait
                    un litige. Le remboursement d&#39;un paiement fait sur le site OGONE&nbsp;ou Paypal
                    occasionnant des frais importants, celui-ci ne sera pas accepté si la raison est
                    une erreur imputable au client.<br />
                    <strong>10 &ndash; Litiges</strong><br />
                    Le présent contrat est soumis au droit belge. La S.P.R.L Servranx ne peut être tenue
                    pour responsable des dommages de quelque nature qu&rsquo;ils soient, tant matériels
                    qu&rsquo;immatériels ou corporels, qui pourraient résulter de mauvaises manipulations
                    des produits commercialisés. Il en est de même pour les éventuelles modifications
                    des produits du chef de nos fournisseurs. La responsabilité de la S.P.R.L Servranx
                    sera, en tout état de cause, limitée au montant de la commande et ne saurait être
                    mise en cause pour de simples erreurs qui auraient pu subsister malgré toutes les
                    précautions prises dans la présentation des produits. En cas de difficultés dans
                    l&rsquo;application du présent contrat, l&rsquo;acheteur a la possibilité, avant
                    ...
                    consommateurs ou de tout autre conseil de son choix. Il est rappelé que la recherche
                    de la solution amiable n&rsquo;interrompt pas le &laquo; bref délai &raquo; de la
                    garantie légale, ni la durée de la garantie contractuelle. Il est rappelé qu&rsquo;en
                    règle générale et sous réserve de l&rsquo;appréciation des tribunaux, le respect
                    des dispositions du présent contrat relatives à la garantie contractuelle suppose
                    que l&rsquo;acheteur honore ses engagements financiers envers le vendeur. Les réclamations
                    ou contestations, qui doivent être introduites par écrit dans les huit jours ouvrables,
                    seront toujours reçues avec une bienveillance attentive, la bonne foi étant toujours
                    présumée chez celui qui prend la peine d&rsquo;exposer ces situations. En cas de
                    litige, le client s&rsquo;adressera par priorité à l&rsquo;entreprise pour obtenir
                    une solution amiable. (Service clients &ndash; Tél. : + 32 2 649 18 40, du lundi
                    au vendredi inclus ou courriel (E-mail) à info@servranx.com). À défaut, le tribunal
                    de commerce de Bruxelles est seul compétent, quels que soient le lieu de livraison
                    et le mode de paiement accepté. Dans tous les cas, la S.P.R.L Servranx ne pourra
                    être tenu pour responsable pour non-respect des dispositions réglementaires et législatives
                    en vigueur dans le pays de réception, la responsabilité de la S.P.R.L Servranx est
                    systématiquement limitée à la valeur du produit mis en cause, valeur à la date de
                    la vente. Si l&rsquo;acheteur s&rsquo;adresse aux tribunaux, il doit le faire dans
                    un &laquo; bref délai &raquo; à compter de la découverte du défaut caché.<br />
                    <strong>11 &ndash; Informations légales</strong><br />
                    Le renseignement des informations nominatives collectées aux fins de la vente à
                    distance est obligatoire, ces informations étant indispensables pour le traitement
                    et l&rsquo;acheminement des commandes, l&rsquo;établissement des factures et contrats
                    de garantie. Le défaut de renseignement entraîne la non-validation de la commande.
                    Conformément à la loi, le client dispose d&rsquo;un droit d&rsquo;accès, de modification,
                    de rectification et de suppression des données qui le concernent, qu&rsquo;il peut
                    exercer auprès de la S.P.R.L Servranx.<br />
                    <strong>12 &ndash;&nbsp; La commande</strong><br />
                    Le fait de passer commande à la S.P.R.L Servranx implique l&rsquo;accord sur tous
                    les points ci-dessus.<br />
                    * S.P.R.L. : société privée à responsabilité limitée.</div>
                <%--   fin--%>
            </div>
        </div>
        <div class="cont_post right cont_check_condition">
            <label>
                ...
                <br />
                <asp:Label ID="LabelLastArticle" runat="server" Text="dérnières articles."></asp:Label></label>
        </div>
        <div class="clr">
        </div>
...
<%--<div class="BlocDroitConso"> Droits du consommateur : délai de rétractation légal de 14 jours.Nos prix sont TVA incluse hors frais d'envoi et de paiement. 
Pour connaître nos conditions d'offres et de ventes, <a href="#">cliquez ici</a>. </div>--%>
