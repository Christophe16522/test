            ...
            if (AuthenticationHelper.IsAuthenticated())
            {
                ...
                if (DisplayInbox)
                {
                    tabMenu.AddTab(new UITabItem
                    {
                        ...
                        RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, ParameterName, TAB_INBOX)),
                    });
                ...
                if (DisplayOutbox)
                {
                    tabMenu.AddTab(new UITabItem
                    {
                        ...
                        RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, ParameterName, TAB_OUTBOX)),
                    });
                ...
                if (DisplayContactList)
                {
                    tabMenu.AddTab(new UITabItem
                    {
                        ...
                        RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, ParameterName, TAB_CONTACT)),
                    });
                ...
                if (DisplayIgnoreList)
                {
                    tabMenu.AddTab(new UITabItem
                    {
                        ...
                        RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, ParameterName, TAB_IGNORE)),
                    });
