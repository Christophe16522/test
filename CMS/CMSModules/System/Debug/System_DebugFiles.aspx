...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <cms:DisabledModule runat="server" ID="ucDisabled" SettingsKeys="CMSDebugFiles;CMSDebugEverything;CMSDebugEverythingEverywhere" InfoText="{$DebugFiles.NotConfigured$}" AtLeastOne="True" />
    <div class="clearfix">
