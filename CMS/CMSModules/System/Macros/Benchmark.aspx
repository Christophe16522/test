    ...
    <div class="form-horizontal">
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel AssociatedControlID="editorElem" ID="lblExpression" CssClass="control-label" runat="server" ResourceString="macros.benchmark.text" />
            </div>
        ...
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel AssociatedControlID="txtIterations" ID="lblIterations" CssClass="control-label" runat="server" ResourceString="macros.benchmark.iterations" />
            </div>
            <div class="editing-form-value-cell">
