...
public partial class CMSModules_Content_CMSDesk_Default : CMSContentPage
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        contentcontrolpanel.Values.AddRange(new[] { new UILayoutValue("NodeID", ResultNodeID), new UILayoutValue("ExpandNodeID", ExpandNodeID), new UILayoutValue("Culture", SelectedCulture), new UILayoutValue("SelectedMode", ResultMode) });
        base.OnInit(e);
    }
