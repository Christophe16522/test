...
"
            ...
            else
            {
                ...
                btnWireframe.Click += new EventHandler(lnkWireframe_Click);
            }
    ...
    private string GetInheritedCacheCaption(string columnName)
    {
        ...
        return ValidationHelper.GetBoolean(Node.GetInheritedValue(columnName, true), false) ? GetString("General.Yes") : GetString("General.No");
