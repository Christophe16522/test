...
<asp:PlaceHolder ID="plcMenu" runat="server">
    <cms:CMSPanel ID="pnlContainer" ShortID="pC" runat="server">
        ...
        <asp:PlaceHolder ID="plcControls" runat="server">
            <asp:Panel ID="pnlRight" runat="server" CssClass="RightAlign btn-actions control-group-inline">
                <cms:CMSCheckBox ID="chkEmails" CssClass="CheckBoxField dont-check-changes" runat="server" Checked="true" />
