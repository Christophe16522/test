...
function FSP_SetLayoutClass(vertical) {
    ...
    if (frameToolbar != null) {
        // Set class
        var btnH = jQuery('.js-split-horizontal', frameToolbar.document).parent();
        var btnV = jQuery('.js-split-vertical', frameToolbar.document).parent();
...
function FSP_SynchronizeToolbar() {
    ...
    if (frameToolbar != null) {
        // Set image src
        var imageSync = jQuery('#' + FSP_syncId, frameToolbar.document);
        if (imageSync != null) {
