...
public partial class CMSModules_Content_Controls_Dialogs_Selectors_LinkMediaSelector_Menu : CMSUserControl
{
    ...
    private void SetupControls()
    {
        ...
        ScriptHelper.RegisterHeaderActionsShadowScript(this.Page);
        ...
        btnPrepareForImport.Visible = StorageHelper.IsExternalStorage(LibraryFolderPath) && !IsCopyMoveLinkDialog;
    }
