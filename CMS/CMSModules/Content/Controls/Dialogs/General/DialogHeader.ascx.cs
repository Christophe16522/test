...
public partial class CMSModules_Content_Controls_Dialogs_General_DialogHeader : CMSUserControl
{
    ...
    private string GetFilePath(string fileName, string parameterName = null, string parameterValue = null)
    {
        ...
        {
            return URLHelper.ResolveUrl(path + fileName) + URLHelper.EncodeQueryString(RequestContext.CurrentQueryString);
        }
    }
    ...
    private string GetMediaLibrariesPath()
    {
        ...
        return URLHelper.ResolveUrl(path) + URLHelper.EncodeQueryString(RequestContext.CurrentQueryString);
    }
    ...
    private void GetTabs()
    {
        ...
        else if (tabControl.TabItems.Count == 1)
        {
            ...
            ScriptHelper.RegisterStartupScript(this, typeof(string), "headerFrameHide", ScriptHelper.GetScript("parent.$j('#rowsFrameset').attr('rows','" + CMSPage.TitleOnlyHeight + ", *, " + CMSPage.FooterFrameHeight + "')"));
        }
    }
