...
public partial class CMSModules_Content_Controls_Dialogs_Properties_HTMLMediaProperties : ItemProperties
{
    ...
    private void LoadImagePreview(bool saveSession = true)
    {
        ...
        int width = widthHeightElem.Width > OriginalWidth ? OriginalWidth : widthHeightElem.Width;
        int height = widthHeightElem.Height > OriginalHeight ? OriginalHeight : widthHeightElem.Height;
