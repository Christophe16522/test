...
public partial class CMSModules_Content_Controls_Relationships_AddRelatedDocument : CMSUserControl
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        {
            sb.Append("jQuery('#", txtLeftNode.ClientID, "').change(ClearDialogNodeId);");
        }

        if (txtRightNode.Visible && txtRightNode.Enabled)
        {
            sb.Append("jQuery('#", txtRightNode.ClientID, "').change(ClearDialogNodeId);");
        }
...
", hdnSelectedNodeId.ClientID);
    ...
    private void RegisterScript()
    {
        ...
        sb.AppendLine("  var leftSide = jQuery('#" + currentOnLeftClientID + "').val();");
        sb.AppendLine("  if (leftSide === 'true') {");
        sb.AppendLine("    jQuery('#" + leftCurentNodeClientID + "').addClass('hidden');");
        sb.AppendLine("    jQuery('#" + leftSelectedNodeClientID + "').removeClass('hidden');");
        sb.AppendLine("    jQuery('#" + rightCurrentNodeClientID + "').removeClass('hidden');");
        sb.AppendLine("    jQuery('#" + rightSelectedNodeClientID + "').addClass('hidden');");
        sb.AppendLine("    jQuery('#" + currentOnLeftClientID + "').val('false');");
        sb.AppendLine("    jQuery('#" + txtLeftNodeClientID + "').val(jQuery('#" + txtRightNodeClientID + "').val());");
        sb.AppendLine("  }");
        sb.AppendLine("  else if (leftSide === 'false') {");
        sb.AppendLine("    jQuery('#" + leftCurentNodeClientID + "').removeClass('hidden');");
        sb.AppendLine("    jQuery('#" + leftSelectedNodeClientID + "').addClass('hidden');");
        sb.AppendLine("    jQuery('#" + rightCurrentNodeClientID + "').addClass('hidden');");
        sb.AppendLine("    jQuery('#" + rightSelectedNodeClientID + "').removeClass('hidden');");
        sb.AppendLine("    jQuery('#" + currentOnLeftClientID + "').val('true');");
        sb.AppendLine("    jQuery('#" + txtRightNodeClientID + "').val(jQuery('#" + txtLeftNodeClientID + "').val());");
        sb.AppendLine("  }");
