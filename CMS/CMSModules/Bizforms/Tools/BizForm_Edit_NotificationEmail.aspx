    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel CssClass="control-label" ID="lblFromEmail" runat="server" EnableViewState="False" ResourceString="BizFormGeneral.lblFromEmail" AssociatedControlID="txtFromEmail" />
            </div>
        ...
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel CssClass="control-label" ID="lblToEmail" runat="server" EnableViewState="False" ResourceString="BizFormGeneral.ToEmail" AssociatedControlID="txtToEmail" />
            </div>
            <div class="editing-form-value-cell">
        ...
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel CssClass="control-label" ID="lblAttachDocs" runat="server" EnableViewState="False" ResourceString="BizForm_Edit_NotificationEmail.AttachUploadedDocs"
