            ...
            if (AuthenticationHelper.IsAuthenticated())
            {
                ...
                if (DisplayFriendsRequested)
                {
                    tabMenu.AddTab(new TabItem
                    {
                        ...
                        RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, ParameterName, "requested"))
                    });
                ...
                if (DisplayFriendsRejected)
                {
                    tabMenu.AddTab(new TabItem
                    {
                        ...
                        RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, ParameterName, "rejected"))
                    });
                ...
                if (DisplayFriendsList)
                {
                    tabMenu.AddTab(new TabItem
                    {
                        ...
                        RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, ParameterName, "friends"))
                    });
