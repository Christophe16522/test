    ...
    <cms:CMSUpdatePanel ID="pnlGrid" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <cms:UniGrid ID="ugRecycleBin" runat="server" HideControlForZeroRows="true" ShowObjectMenu="false"
                ...
                <GridOptions ShowSelection="true" SelectionColumn="VersionID" DisplayFilter="true" FilterPath="~/CMSModules/Content/Controls/Filters/ObjectsRecycleBinFilter.ascx" />
            </cms:UniGrid>
