...
public partial class CMSModules_OnlineMarketing_Pages_Content_ABTesting_ABTest_List : CMSABTestPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        var infoTexts = ucDisabledModule.InfoTexts;

        infoTexts.Add(GetString("WebAnalytics.Disabled") + "</br>");
        infoTexts.Add(GetString("abtesting.disabled") + "</br>");
        infoTexts.Add(GetString("webanalytics.tackconversionsdisabled"));
