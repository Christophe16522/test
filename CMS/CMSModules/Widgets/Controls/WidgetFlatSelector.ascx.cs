...
public partial class CMSModules_Widgets_Controls_WidgetFlatSelector : CMSAdminControl
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        {
            flatElem.WhereCondition = SqlHelper.AddWhereCondition(flatElem.WhereCondition, SqlHelper.GetWhereCondition("WidgetName", currentUser.UserSettings.UserUsedWidgets.Split(';')));
        }
