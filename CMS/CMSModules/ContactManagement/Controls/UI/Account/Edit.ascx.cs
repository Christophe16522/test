...
public partial class CMSModules_ContactManagement_Controls_UI_Account_Edit : CMSAdminEditControl
{
    ...
    protected void HeaderActions_ActionPerformed(object sender, CommandEventArgs e)
    {
        ...
        switch (e.CommandName.ToLowerCSafe())
        {
            ...
            case "split":
                List<AccountInfo> mergedAccount = new List<AccountInfo>(1) { (AccountInfo)UIContext.EditedObject };
                AccountHelper.Split(parentAccount, mergedAccount, false, false, false);
                SetButtonsVisibility();
