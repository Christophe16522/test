            ...
            if (formField != null)
            {
                ...
                if (mappingItem != null)
                {
                    ...
                    if (entityAttribute != null)
                    {
                        ...
                        formFieldPanel.Controls.Add(new Literal { Text = ResHelper.LocalizeString(formField.GetPropertyValue(FormFieldPropertyEnum.FieldCaption, MacroContext.CurrentResolver)) });
