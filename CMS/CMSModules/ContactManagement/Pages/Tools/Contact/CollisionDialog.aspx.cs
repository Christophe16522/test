...
public partial class CMSModules_ContactManagement_Pages_Tools_Contact_CollisionDialog : CMSModalPage
{
    ...
    private string AccountContactTooltip(IList<int> roleIDs)
    {
        ...
        if (contactRoles.Any())
        {
            ...
            {
                sb.AppendFormat("<br />&nbsp;-&nbsp;{0}", HTMLHelper.HTMLEncode(contactRole.ContactRoleDisplayName));
            }
        }
    ...
    private string FillTooltipDataForMonitored(HtmlGenericControl image, bool fieldValue)
    {
        ...
        // Merged values
        output += "<br /><br /><em>" + GetString("om.contact.mergedvalues") + "</em><br />";

        // Loop through all TRUE values of given column
        output += "<br />";
        output += "<strong>" + GetString("om.contact.ismonitored") + "</strong><br />";
        ...
        {
            output += "&nbsp;-&nbsp;" + HTMLHelper.HTMLEncode(ValidationHelper.GetString(contactRow["ContactFullNameJoined"], "").Trim()) + "<br />";
        }

        // Loop through all FALSE values of given column
        output += "<br />";
        output += "<strong>" + GetString("om.contact.isnotmonitored") + "</strong><br />";
        // Sort contacts by full name
        mMergedContacts.Tables[0].DefaultView.Sort = "ContactFullNameJoined";
        ...
        else
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                if (fieldName == "ContactBirthday")
                {
                    ...
                    output += "<strong>" + HTMLHelper.HTMLEncode(ValidationHelper.GetDateTime(value, DateTimeHelper.ZERO_TIME).ToShortDateString()) + "</strong><br />";
                ...
                else
                {
                    ...
                    contactsView.RowFilter = fieldName + " = '" + ContactHelper.EscapeString((string)value) + "'";
                }
    ...
    {
        return "<strong>" + HTMLHelper.HTMLEncode(text) + "</strong><br />";
    }
    ...
    private void InitNotes()
    {
        ...
        if ((table.Rows != null) && (table.Rows.Count > 0))
        {
            ...
            htmlNotes.Value += "<br />" + mStamp + "<br />" + GetString("om.contact.notesmerged");
        }
    }
