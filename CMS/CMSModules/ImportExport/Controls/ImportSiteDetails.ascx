            ...
            <div class="selector-subitem">
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <asp:Label CssClass="control-label" ID="lblSiteDisplayName" runat="server" EnableViewState="false" AssociatedControlID="txtSiteDisplayName" />
                    </div>
                ...
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <asp:Label CssClass="control-label" ID="lblDomain" runat="server" EnableViewState="false" AssociatedControlID="txtDomain" />
                    </div>
                    <div class="editing-form-value-cell">
