...
public partial class CMSModules_ImportExport_Controls_ImportSiteDetails : CMSUserControl
{
    ...
    public string Culture
    {
        get
        {
            return DataHelper.GetNotEmpty(cultureElem.Value, SettingsKeyInfoProvider.GetStringValue("CMSDefaultCultureCode"));
        }
        set
        {
    ...
    public bool ApplySettings()
    {
        ...
        if (radNewSite.Checked)
        {
            ...
            {
                var dummySite = new SiteInfo()
                {
                    SiteName = ValidationHelper.GetCodeName(txtSiteDisplayName.Text),
                };
                dummySite.Generalized.EnsureUniqueCodeName();
                siteName = dummySite.SiteName;
            }
