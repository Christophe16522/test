...
<asp:Content ID="cultureContent" runat="server" ContentPlaceHolderID="plcBeforeActions" >
...
<asp:Content ContentPlaceHolderID="plcContent" ID="content" runat="server">
    <cms:UniGrid ID="gridStrings" runat="server" OrderBy="StringKey" IsLiveSite="false" ObjectType="cms.resourcestringlist"
        ...
        <GridColumns>
            ...
            <ug:Column Source="CultureText" ExternalSourceName="culturetext" Caption="$culture.translated$" Width="50%" Wrap="false">
                <Filter Type="text" />
            </ug:Column>
            <ug:Column Source="DefaultText" ExternalSourceName="defaulttext" Localize="true" IsText="true" Width="50%" Caption="general.default" Wrap="false">
                <Filter Type="text" />
            </ug:Column>
