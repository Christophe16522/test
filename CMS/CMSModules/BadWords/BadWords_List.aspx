...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <cms:UniGrid runat="server" ID="UniGrid" 
        ...
        <GridColumns>
            <ug:Column source="WordExpression" caption="$Unigrid.BadWords.Columns.WordExpression$" wrap="false" width="100%" maxlength="100" >
                <tooltip source="WordExpression" width="0" />
            </ug:Column>
            <ug:Column source="WordAction" externalsourcename="WordAction" caption="$Unigrid.BadWords.Columns.WordAction$" wrap="false" width="200px" />
            <ug:Column source="##ALL##" externalsourcename="WordReplacement" caption="$Unigrid.BadWords.Columns.WordReplacement$" sort="WordReplacement" wrap="false" width="200px" />
