...
public partial class CMSModules_AdminControls_Controls_UIControls_MetaFileList : CMSAbstractUIWebpart
{
    ...
    protected void Page_Load(object sender, EventArgs eventArgs)
    {
        ...
        IEnumerable<string> allowedExtensionsFromSettings = SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSUploadExtensions").Split(new[] { ';' }, StringSplitOptions.RemoveEmptyEntries);
