<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GeneralTree.ascx.cs" Inherits="CMSModules_AdminControls_Controls_UIControls_GeneralTree" %>
...
<script type="text/javascript" language="javascript">
    ...
    function updateMenu() {
        ...
        updateMenuItem('#' + '<%=ExportItemButton.ClientID %>', !isItem);
    ...
    function SelectNode(elementId, type, parentId, updateContent, suffix) {
        selectedItemId = elementId;
        selectedItemType = type;
        selectedItemParent = parentId;

        // Set selected item in tree
        jQuery('span[name=treeNode]').each(function () {
            var jThis = $j(this);
