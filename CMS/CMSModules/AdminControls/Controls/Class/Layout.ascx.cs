...
public partial class CMSModules_AdminControls_Controls_Class_Layout : CMSUserControl
{
    ...
    private void InitHeaderActions()
    {
        ...
        layoutAction = new HeaderAction
        {
            ...
            OnClientClick = (LayoutTypeEnum.Html.ToString() == drpLayoutType.SelectedValue) ? "SetContent(GenerateHtmlLayout()); return false;"
                                                                                       : "SetContent(GenerateAscxLayout()); return false;",
