...
function GenerateHtmlLayout() {
    ...
    for (var i = 0; i < optionsCount; i++) {
        htmlLayout += "<tr><td>$$label:" + list.options[i].value + "$$</td><td>$$input:" + list.options[i].value + "$$</td><td>$$validation:" + list.options[i].value + "$$</td></tr>";
        rowAdded = true;
    }

    if (rowAdded) {
        htmlLayout = "<table><tbody>" + htmlLayout + "</tbody></table>";
    }
