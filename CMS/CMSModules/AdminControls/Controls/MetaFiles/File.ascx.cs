...
function OpenEditor(queryString) {{ 
    ...
    public override bool IsValid()
    {
        ...
        {
            string extensions = string.IsNullOrEmpty(AllowedExtensions) ? SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSUploadExtensions") : AllowedExtensions;
