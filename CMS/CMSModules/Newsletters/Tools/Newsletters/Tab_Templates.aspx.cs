...
public partial class CMSModules_Newsletters_Tools_Newsletters_Tab_Templates : CMSNewsletterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        usTemplates.WhereCondition = String.Format("TemplateType='{0}' AND TemplateSiteID={1} AND TemplateID<>{2}", SqlHelper.GetSafeQueryString(EmailTemplateType.Issue), mNewsletter.NewsletterSiteID, mNewsletter.NewsletterTemplateID);
