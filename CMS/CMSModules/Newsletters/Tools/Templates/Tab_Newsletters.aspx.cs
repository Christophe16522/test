...
public partial class CMSModules_Newsletters_Tools_Templates_Tab_Newsletters : CMSNewsletterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        usNewsletters.WhereCondition = String.Format("NewsletterSiteID={0} AND NewsletterType='{1}' AND NewsletterTemplateID<>{2}", SiteContext.CurrentSiteID,
            SqlHelper.GetSafeQueryString(NewsletterType.TemplateBased), emailTemplateInfo.TemplateID);
