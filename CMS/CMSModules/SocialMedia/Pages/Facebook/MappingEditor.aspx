    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            if (mappingField != null && sourceMappingField != null && mappingField.value != null && mappingField.value != '') {
                ...
                jQuery("select.AttributeDropDownList").each(function (index, select) {
                    jQuery(select).find('option[value^="Attribute"]').wrapAll("<optgroup label='" + attributeLabel + "'>");
                    jQuery(select).find('option[value^="RestrictedAttribute"]').wrapAll("<optgroup label='" + restrictedAttributeLabel + "'>");
