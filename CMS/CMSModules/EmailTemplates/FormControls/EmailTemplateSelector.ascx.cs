...
public partial class CMSModules_EmailTemplates_FormControls_EmailTemplateSelector : FormEngineUserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            usTemplate.WhereCondition = SqlHelper.AddWhereCondition(usTemplate.WhereCondition, "EmailTemplateType = '" + SqlHelper.GetSafeQueryString(TemplateType.Value.ToStringRepresentation<EmailTemplateTypeEnum>()) + "'");
        }
