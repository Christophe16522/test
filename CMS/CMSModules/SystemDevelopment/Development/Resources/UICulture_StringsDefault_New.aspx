<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="CMSModules_SystemDevelopment_Development_Resources_UICulture_StringsDefault_New"
    MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" Theme="Default" Title="Default strings - String New" CodeFile="UICulture_StringsDefault_New.aspx.cs" %>

<asp:Content ContentPlaceHolderID="plcContent" ID="content" runat="server">
    <div class="form-horizontal">
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel CssClass="control-label" ID="lblKey" runat="server" ResourceString="culture.key"
                    DisplayColon="true" EnableViewState="false" AssociatedControlID="txtKey" />
            </div>
