    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (selected > 0)
        {
            ...
            if (fpi != null)
            {
                ...
                ucAbuse.ReportTitle = ResHelper.GetString("Forums_WebInterface_ForumPost.AbuseReport", SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSDefaultCulture")) + fpi.PostText;
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (mSelectedPost > 0)
        {
            ...
            if ((fpi != null) && (ForumContext.CurrentForum != null) && (fpi.PostForumID == ForumContext.CurrentForum.ForumID))
            {
                ...
                ltlPostTime.Text = TimeZoneMethods.ConvertDateTime(fpi.PostTime, this).ToString();
