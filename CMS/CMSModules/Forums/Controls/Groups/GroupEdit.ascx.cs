...
public partial class CMSModules_Forums_Controls_Groups_GroupEdit : CMSAdminEditControl
{
    ...
    private void SetUrl()
    {
        ...
        if (DisplayMode != ControlDisplayModeEnum.Simple)
        {
            ...
            string baseUrl = ValidationHelper.GetString(SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSForumBaseUrl"), "");
            string unsubscriptionUrl = ValidationHelper.GetString(SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSForumUnsubscriptionUrl"), "");
        ...
        string optInApprovalUrl = ValidationHelper.GetString(SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSForumOptInApprovalPath"), "");
