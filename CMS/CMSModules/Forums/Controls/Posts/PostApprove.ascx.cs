...
public partial class CMSModules_Forums_Controls_Posts_PostApprove : CMSAdminEditControl
{
    ...
    private bool CheckSubscription()
    {
        ...
        DataSet ds = ForumSubscriptionInfoProvider.GetSubscriptions("(SubscriptionUserID = " + MembershipContext.AuthenticatedUser.UserID + ") AND (SubscriptionPostID = " + PostID + ") AND (ISNULL(SubscriptionApproved, 1) = 1)", null, 0, "SubscriptionID");
