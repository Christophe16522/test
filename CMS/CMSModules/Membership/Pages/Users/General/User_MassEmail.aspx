...
<asp:Content ID="cntSite" ContentPlaceHolderID="plcBeforeActions" runat="Server">
    ...
    <div class="form-horizontal">
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel CssClass="control-label" ID="lblFrom" runat="server" AssociatedControlID="txtFrom" EnableViewState="false" ResourceString="general.fromemail" DisplayColon="true" />
            </div>
            <div class="editing-form-value-cell">
                <cms:CMSTextBox ID="txtFrom" runat="server" />
            </div>
        </div>
        <div class="form-group">
            <div class="editing-form-label-cell">
