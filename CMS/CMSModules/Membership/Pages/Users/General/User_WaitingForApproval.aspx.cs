...
public partial class CMSModules_Membership_Pages_Users_General_User_WaitingForApproval : CMSUsersPage
{
    ...
    protected void SetUserInfo(int userID)
    {
        ...
        if (!String.IsNullOrEmpty(user.Email))
        {
            ...
            if (template != null)
            {
                string from = EmailHelper.GetSender(template, SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSNoreplyEmailAddress"));
    ...
    protected void DeleteUser(int userID)
    {
        ...
        if (hdnSendEmail.Value == "true")
        {
            ...
            string from = SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSNoreplyEmailAddress");
