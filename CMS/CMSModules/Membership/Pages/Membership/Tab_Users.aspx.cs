...
public partial class CMSModules_Membership_Pages_Membership_Tab_Users : CMSMembershipPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        usUsers.DialogWindowHeight = 630;
    ...
    private object usUsers_OnAdditionalDataBound(object sender, string sourceName, object parameter, object val)
    {
        ...
        switch (sourceName.ToLowerCSafe())
        {
            ...
            case "calendar":
                ...
                {
                    onClick = "$j('#" + hdnDate.ClientID + "').val('" + itemID + "');" + ucCalendar.GenerateNonCustomCalendarImageEvent();
                }
                else
                {
                    onClick = "$j('#" + hdnDate.ClientID + "').val('" + itemID + "'); var dt = $j('#" + ucCalendar.DateTimeTextBox.ClientID + "'); dt.val('" + date + "'); dt.cmsdatepicker('setLocation','" + iconID + "'); dt.cmsdatepicker ('show');";
                }
