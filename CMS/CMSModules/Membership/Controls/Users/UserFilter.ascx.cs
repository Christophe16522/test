...
public partial class CMSModules_Membership_Controls_Users_UserFilter : CMSAbstractBaseFilterControl, IUserFilter
{
    ...
    public bool ContactManagementPermission
    {
        get
        {
            return ResourceSiteInfoProvider.IsResourceOnSite("CMS.ContactManagement", SiteContext.CurrentSiteName)
                     ...
                     && ModuleEntryManager.IsModuleLoaded("CMS.ContactManagement");
        }
    }
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        if (usersPage != null)
        {
            CurrentMode = usersPage.CurrentMode;
    ...
    public string AdvancedSearch()
    {
        ...
        if (firstLetter != "" && firstLetter != "ALL")
        {
            if (SessionInsteadOfUser)
            {
                whereCond += (String.IsNullOrEmpty(whereCond) ? "" : " AND ") + "(SessionFullName LIKE N'" + SecurityHelper.GetSafeQueryString(firstLetter, false) + "%')";
            }
            else
            {
                whereCond += (String.IsNullOrEmpty(whereCond) ? "" : " AND ") + "(UserName LIKE N'" + SecurityHelper.GetSafeQueryString(firstLetter, false) + "%')";
            }
        }
    ...
    public string SimpleSearch()
    {
        ...
        if (firstLetter != "" && firstLetter != "ALL")
        {
            ...
            if (SessionInsteadOfUser)
            {
                where += "(SessionFullName LIKE N'" + SecurityHelper.GetSafeQueryString(firstLetter, false) + "%')";
            }
            else
            {
                where += "(UserName LIKE N'" + SecurityHelper.GetSafeQueryString(firstLetter, false) + "%')";
            }
        }
