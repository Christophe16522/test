...
public partial class CMSModules_Membership_Controls_ResetPassword : CMSUserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            // Get user info
            UserInfo ui = UserInfoProvider.GetUserInfoWithSettings("UserPasswordRequestHash = '" + SqlHelper.GetSafeQueryString(hash, true) + "'");
            if (ui != null)
            {
        ...
        if (!URLHelper.IsPostback())
        {
            ...
            // Prepare query
            string query = "UserPasswordRequestHash = '" + SqlHelper.GetSafeQueryString(hash, true) + "'";
