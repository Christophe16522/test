    ...
    <cms:CMSUpdatePanel ID="pnlUpdate" runat="server">
        <ContentTemplate>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" runat="server" ID="lblFrom" ResourceString="general.from" DisplayColon="true" />
                    </div>
                    <div class="editing-form-value-cell">
                ...
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" runat="server" ID="lblTo" ResourceString="general.to" DisplayColon="true" />
                    </div>
                    <div class="editing-form-value-cell">
