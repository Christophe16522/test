    ...
    <asp:Panel runat="server" ID="pnlContent">
        ...
        <asp:Panel runat="server" ID="pnlList" EnableViewState="false">
            <div class="form-horizontal">
                ...
                <asp:Panel runat="server" ID="pnlSeparateSubmissions" CssClass="form-group" Visible="False">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" runat="server" DisplayColon="True" AssociatedControlID="chkSeparateSubmissions" ResourceString="translations.useseparatesubmissions" />
                    </div>
                    <div class="editing-form-value-cell">
        ...
        <asp:Panel runat="server" ID="pnlButtons" CssClass="control-group-inline">
            ...
            <cms:LocalizedButton ID="btnNo" runat="server" ButtonStyle="Primary" ResourceString="general.cancel"
