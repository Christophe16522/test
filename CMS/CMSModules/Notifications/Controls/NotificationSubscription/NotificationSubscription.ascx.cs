                ...
                if (g.NotificationGatewayObj != null && g.NotificationGatewayForm != null)
                {
                    ...
                    foreach (NotificationSubscriptionInfo nsiTemplate in Subscriptions)
                    {
                        ...
                        string where = "SubscriptionEventSource = '" + SqlHelper.GetSafeQueryString(nsi.SubscriptionEventSource, false) + "' AND " +
                                       ...
                                       "SubscriptionEventData1 LIKE '" + SqlHelper.GetSafeQueryString(nsi.SubscriptionEventData1, false) + "' AND " +
                                       "SubscriptionEventData2 LIKE '" + SqlHelper.GetSafeQueryString(nsi.SubscriptionEventData2, false) + "' AND ";
