...
public partial class CMSModules_MediaLibrary_Controls_UI_MediaLibraryEdit : CMSAdminEditControl
{
    ...
    {
        MediaLibraryInfo library = MediaLibraryInfoProvider.GetMediaLibraries("LibraryFolder = '" + SqlHelper.GetSafeQueryString(folderName) + "' AND LibrarySiteID = " + SiteContext.CurrentSiteID, null, 1, "LibraryID").FirstOrDefault();
