    ...
    protected override void CreateChildControls()
    {
        ...
        if (ShowGeneralTab)
        {
            tabMenu.AddTab(new TabItem()
            {
                ...
                RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, "tab", "general")),
            });
            defaultTab = "general";
            generalTabIndex = i;
            i++;
        ...
        if (ShowSecurityTab)
        {
            tabMenu.AddTab(new TabItem()
            {
                ...
                RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, "tab", "security")),
            });
        ...
        if (ShowMembersTab)
        {
            tabMenu.AddTab(new TabItem()
            {
                ...
                RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, "tab", "members")),
            });
            if (String.IsNullOrEmpty(defaultTab))
            {
                defaultTab = "members";
        ...
        if (ShowRolesTab && ResourceSiteInfoProvider.IsResourceOnSite("CMS.Roles", SiteContext.CurrentSiteName))
        {
            tabMenu.AddTab(new TabItem()
            {
                ...
                RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, "tab", "roles")),
            });
            if (String.IsNullOrEmpty(defaultTab))
            {
                defaultTab = "roles";
        ...
        if (ShowForumsTab && ResourceSiteInfoProvider.IsResourceOnSite("CMS.Forums", SiteContext.CurrentSiteName))
        {
            tabMenu.AddTab(new TabItem()
            {
                ...
                RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, "tab", "forums")),
            });
            if (String.IsNullOrEmpty(defaultTab))
            {
                defaultTab = "forums";
        ...
        if (ShowMediaTab && ResourceSiteInfoProvider.IsResourceOnSite("CMS.MediaLibrary", SiteContext.CurrentSiteName))
        {
            tabMenu.AddTab(new TabItem()
            {
                ...
                RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, "tab", "medialibrary")),
            });
            if (String.IsNullOrEmpty(defaultTab))
            {
        ...
        if (ShowMessageBoardsTab && ResourceSiteInfoProvider.IsResourceOnSite("CMS.MessageBoards", SiteContext.CurrentSiteName))
        {
            tabMenu.AddTab(new TabItem()
            {
                ...
                RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, "tab", "messageboards")),
            });
            if (String.IsNullOrEmpty(defaultTab))
            {
        ...
        if (ShowPollsTab && ResourceSiteInfoProvider.IsResourceOnSite("CMS.Polls", SiteContext.CurrentSiteName))
        {
            tabMenu.AddTab(new TabItem()
            {
                ...
                RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, "tab", "polls")),
            });
            if (String.IsNullOrEmpty(defaultTab))
            {
                defaultTab = "polls";
            ...
            if (LicenseHelper.CheckFeature(RequestContext.CurrentDomain, FeatureEnum.ProjectManagement))
            {
                ...
                if (ResourceSiteInfoProvider.IsResourceOnSite("CMS.ProjectManagement", SiteContext.CurrentSiteName))
                {
                    tabMenu.AddTab(new TabItem()
                    {
                        ...
                        RedirectUrl = HTMLHelper.HTMLEncode(URLHelper.AddParameterToUrl(absoluteUri, "tab", "projects")),
                    });
                    if (String.IsNullOrEmpty(defaultTab))
                    {
                        defaultTab = "projects";
