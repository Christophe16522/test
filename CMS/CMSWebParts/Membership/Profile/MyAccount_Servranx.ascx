<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_Membership_Profile_MyAccount_Servranx"
    CodeFile="~/CMSWebParts/Membership/Profile/MyAccount_Servranx.ascx.cs" %>
