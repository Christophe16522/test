...
function UpdateLabel_", ClientID, @"(content, context) {
    ...
    private void btnPasswdRetrieval_Click(object sender, EventArgs e)
    {
        ...
        if (value != String.Empty)
        {
            ...
            bool success;
            lblResult.Text = AuthenticationHelper.ForgottenEmailRequest(value, SiteContext.CurrentSiteName, "LOGONFORM", SendEmailFrom, MacroContext.CurrentResolver, ResetPasswordURL, out success, returnUrl);
