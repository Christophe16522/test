...
{
    private static string loginPage = SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSSecuredAreasLogonPage");
    ...
    public string TrackConversionName
    {
        get
        {
            return ValidationHelper.GetString(GetValue("TrackConversionName"), SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSLiveIDConversionName"));
        }
        set
        {
