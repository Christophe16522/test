...
public partial class CMSWebParts_Membership_Registration_RegistrationForm : CMSAbstractWebPart
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            // Encode brackets and set to textbox to ensure max length after encoding
            txtFirstName.Text = HTMLHelper.EncodeAngleBrackets(txtFirstName.Text.Trim());
            txtLastName.Text = HTMLHelper.EncodeAngleBrackets(txtLastName.Text.Trim());
