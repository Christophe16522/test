...
public partial class CMSWebParts_Membership_Registration_registrationform_1 : CMSAbstractWebPart
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if ((txtLastName.Text == "") || (txtLastName.Text == "LastName") || (txtLastName.Text == "Pr�nom"))
            {
                lblError.Visible = true;
            ...
            {
                if ((((txtPassword.Text != "") && (txtPassword.Text != "Password") && (txtConfirmPassword.Text == "Confirm password")) || ((txtPassword.Text != "") && (txtPassword.Text == "Password")) && ((txtConfirmPassword.Text != "Confirm password")) || ((txtPassword.Text != "") && (txtPassword.Text != "Password")) && ((txtConfirmPassword.Text != "Confirm password"))) && (txtPassword.Text != txtConfirmPassword.Text))
                {
                    lblError.Visible = true;
                    lblError.Text = "The 2 passwords are different";
                    return;
                }
            }
            else if (Convert.ToString(currentUI) == "fr-FR")
            {
                ...
                if ((((txtPassword.Text != "") && (txtPassword.Text != "Mot de passe") && (txtConfirmPassword.Text == "Confirmer mot de passe")) || ((txtPassword.Text != "") && (txtPassword.Text == "Mot de passe")) && ((txtConfirmPassword.Text != "Confirmer mot de passe")) || ((txtPassword.Text != "") && (txtPassword.Text != "Mot de passe")) && ((txtConfirmPassword.Text != "Confirmer mot de passe"))) && (txtPassword.Text != txtConfirmPassword.Text))
                {
                    lblError.Visible = true;
                    lblError.Text = "Les 2 mots de passe sont diff�rents";
                    return;
                }
            }*/
            /*
            ...
            if ((((txtPassword.Text != "Password") && (txtConfirmPassword.Text == "Confirm password")) || ((txtPassword.Text == "Password") && (txtConfirmPassword.Text != "Confirm password")) || ((txtPassword.Text != "Mot de passe") && (txtConfirmPassword.Text != "Confirmer mot de passe") && (txtPassword.Text != "Password") && (txtConfirmPassword.Text != "Confirm password")) || ((txtPassword.Text != "Mot de passe") && (txtConfirmPassword.Text == "Confirmer mot de passe")) || ((txtPassword.Text == "Mot de passe") && (txtConfirmPassword.Text != "Confirmer mot de passe"))) && (txtPassword.Text != txtConfirmPassword.Text))
            {
                lblError.Visible = true;
                lblError.Text = GetString("errormdp"); // +" " + txtPassword.Text + " " + txtConfirmPassword.Text;
                return;
            }*/

            #endregion"

            #region "Validation mot de passe"
            /*
            if ((PasswordMinLength > 0) && (txtPassword.Text.Length < PasswordMinLength))
            {
                lblError.Visible = true;
