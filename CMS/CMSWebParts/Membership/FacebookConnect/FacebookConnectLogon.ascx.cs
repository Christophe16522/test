...
public partial class CMSWebParts_Membership_FacebookConnect_FacebookConnectLogon : CMSAbstractWebPart
{
    ...
    private string FromAddress
    {
        get
        {
            return SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSNoreplyEmailAddress");
        }
    }
    ...
    private string ToAddress
    {
        get
        {
            return SettingsKeyInfoProvider.GetStringValue(SiteContext.CurrentSiteName + ".CMSAdminEmailAddress");
        }
    }
    ...
    protected void SetupControl()
    {
        ...
        if ((QueryHelper.GetInteger("logout", 0) > 0) && (QueryHelper.ValidateHash("logout_hash", "aliaspath")))
        {
            LogoutUser();
            return;
        }
    ...
    private void LogoutUser()
    {
        ...
        string redirectUrl = URLHelper.RemoveParameterFromUrl(RequestContext.CurrentURL, "logout");
        redirectUrl = URLHelper.RemoveParameterFromUrl(redirectUrl, "logout_hash");
