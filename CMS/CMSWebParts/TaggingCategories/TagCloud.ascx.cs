    ...
    public string TagGroupName
    {
        get
        {
            ...
            if (String.IsNullOrEmpty(tagGroupName))
            {
                ...
                {
                    tagGroupId = ValidationHelper.GetInteger(DocumentContext.CurrentDocument.GetInheritedValue("DocumentTagGroupID", SiteInfoProvider.CombineWithDefaultCulture(SiteContext.CurrentSiteName)), 0);
                }
