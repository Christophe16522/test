                          ...
                          <div class="cent_list">                          
                            ...
                            <div class="left">
                              ...
                              <ul class="info_produit">
                                <li class="first"><span>Réf:</span><%# GetProductReference(Eval("OrderItemSKUID"))%></li>
                                <li class="second"><span>Qté:</span><%# Eval("OrderItemUnitCount")%> </li>
                                <li class="third"><span>Prix unitaire:</span> <%# GetFormatedPrice(Eval("OrderItemSKUID"), Eval("OrderItemUnitPrice"))%> €</li>
                                <li class="last"><span>Sous total:</span> <%# GetSousTotal(Eval("OrderItemUnitCount"), GetFormatedPrice(Eval("OrderItemSKUID"), Eval("OrderItemUnitPrice")))%> €</li>
                              </ul>
                            </div>
                          </div>
