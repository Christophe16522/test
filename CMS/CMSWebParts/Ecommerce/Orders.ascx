...
<cms:UniGrid runat="server" ID="gridElem" ObjectType="ecommerce.orderlist" RememberStateByParam="customerId"
    RememberDefaultState="true" Columns="OrderID,OrderInvoiceNumber,facture,CustomerFirstName,CustomerLastName,CustomerCompany,CustomerEmail,OrderDate,
    ...
    <GridColumns>
        <ug:Column Name="IDAndInvoice" Source="##ALL##" ExternalSourceName="IDAndInvoice1"
            Caption="Facture" Sort="OrderID" Wrap="false" />
        ...
        <ug:Column Name="Customer" Source="##ALL##" ExternalSourceName="Customermail" Caption="Email"
            Sort="CustomerLastName" Wrap="false">
            <Tooltip Encode="true" Source="CustomerEmail" />
        </ug:Column>
