...
public partial class CMSWebParts_Ecommerce_Orders : CMSAbstractWebPart
{
    ...
    private const string COLUMN_ID_AND_INVOICE1 = "IDANDINVOICE1";
    private const string COLUMN_CUSTOMER = "CUSTOMER";
    private const string COLUMN_CUSTOMERMAIL = "CUSTOMERMAIL";
    ...
    public string CustomerOrCompanymail
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("CustomerOrCompanymail"), "");
        }
        set
        {
            this.SetValue("CustomerOrCompanymail", value);
        }
    }
    ...
    private object gridElem_OnExternalDataBound(object sender, string sourceName, object parameter)
    {
        ...
        switch (sourceName.ToLowerCSafe())
        {
            case "idandinvoice":
               ...
               // string invoiceNumber = ValidationHelper.GetString(dr["facture"], "");
            ...
            case "customermail":
                dr = (DataRowView)parameter;
                string customerName1 = dr["CustomerEmail"].ToString() ;
               
                return HTMLHelper.HTMLEncode(customerName1);
