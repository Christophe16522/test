...
public partial class CMSWebParts_Ecommerce_EcommerceSettingsChecker : CMSAbstractWebPart
{
    ...
    private bool mGlobalUsage = (ECommerceSettings.AllowGlobalProducts(SiteContext.CurrentSiteName) || ECommerceSettings.AllowGlobalProductOptions(SiteContext.CurrentSiteName) || ECommerceSettings.AllowGlobalShippingOptions(SiteContext.CurrentSiteName) || ECommerceSettings.AllowGlobalDiscountCoupons(SiteContext.CurrentSiteName) || ECommerceSettings.UseGlobalCredit(SiteContext.CurrentSiteName) || ECommerceSettings.UseGlobalTaxClasses(SiteContext.CurrentSiteName));
