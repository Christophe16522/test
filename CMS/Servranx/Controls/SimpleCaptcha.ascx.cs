...
public partial class Servranx_Controls_SimpleCaptcha : FormEngineUserControl, ICaptchaControl
{
    #region "Variables"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Convert.ToString(currentUI) == "en-US") txtSecurityCode_TextBoxWatermarkExtender.WatermarkText = "COPY THE CODE";
        else if (Convert.ToString(currentUI) == "fr-FR") txtSecurityCode_TextBoxWatermarkExtender.WatermarkText = "COPIER LE CODE";
