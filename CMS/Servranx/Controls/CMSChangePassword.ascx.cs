...
public partial class CMSChangePassword : CMSUserControl
{
    #region "Variables"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // rfvConfirmPassword.Text = GetString("general.requiresvalue");
        ...
        passStrength.TextBoxAttributes.Add("title", ResHelper.LocalizeString("{$password$}"));
        txtConfirmPassword.Attributes.Add("title", ResHelper.LocalizeString("{$ConfirmPassword$}"));
