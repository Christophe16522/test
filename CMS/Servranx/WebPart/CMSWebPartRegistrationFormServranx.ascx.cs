...
public partial class CMSWebPartRegistrationFormServranx : CMSAbstractWebPart
{
        ...
        else
        {
            if(chkAccept.Checked)
            {
                ...
                if(chkShippingAddr.Checked)
                {
                    ...
                    SetAdresseBilling(Numero, txtadresse1.Text, txtadresse2.Text, txtcp.Text, txtville.Text, ci.CustomerID, true, false, CountryID);
                    SetAdresseShipping(txtnumeroshipping.Text, txtadresse1shipping.Text, txtadresse2shipping.Text, txtcpshipping.Text, txtvilleshipping.Text, ci.CustomerID, false, true, ShippingCountryID);
                }
                else
                {
                    SetAdresseBilling(Numero, txtadresse1.Text, txtadresse2.Text, txtcp.Text, txtville.Text, ci.CustomerID, true, true, CountryID);
                }
    ...
    private void SetAdresseBilling(string numero, string adresse1, string adresse2, string cp1, string ville1, int cuid, bool adrbil, bool adrship, int pays)
    {
    ...
    private void SetAdresseShipping(string numero, string adresse1, string adresse2, string cp1, string ville1, int cuid, bool adrbil, bool adrship, int pays)
    {
