<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CMSWebPartUpdateRegistrationForm.ascx.cs" Inherits="CMSWebPartUpdateRegistrationForm" %>
...
<asp:Panel ID="pnlForm" runat="server" DefaultButton="btnOK">
    ...
    <div class="cont_client">
        ...
        <ajaxToolkit:TextBoxWatermarkExtender ID="wmTelephone" runat="server" TargetControlID="txtTelephone" WatermarkText="Telephone"></ajaxToolkit:TextBoxWatermarkExtender>
        <ajaxToolkit:FilteredTextBoxExtender ID="ftbe" runat="server" TargetControlID="txtTelephone" ValidChars="+1234567890" />
