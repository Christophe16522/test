...
public partial class CMSAdminControls_Validation_CssValidator : DocumentValidator
{
    ...
    private string mExcludedCSS = ";designmode.css;bootstrap.css;bootstrap-additional.css;";
    ...
    private void Validate()
    {
        ...
        // Get the full domain
        ctlAsync.Parameter = RequestContext.FullDomain + ";" + URLHelper.GetFullApplicationUrl() + ";" + URLHelper.RemoveProtocolAndDomain(Url);
        ...
        while (validatedUrls.Count > 0)
        {
            ...
            if (!String.IsNullOrEmpty(cssData))
            {
                ...
                try
                {
                    ...
                    string[] currentUrlValues = parameter.Split(new[]
                    {
                        ';'
