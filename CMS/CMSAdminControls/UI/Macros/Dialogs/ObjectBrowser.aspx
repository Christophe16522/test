        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel AssociatedControlID="editorElem" ID="lblExpression" CssClass="control-label" runat="server" ResourceString="macros.console.expression" />
                </div>
            ...
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel AssociatedControlID="editorElem" ID="lblMode" CssClass="control-label" runat="server" ResourceString="macros.console.mode" />
                </div>
            ...
            <div class="form-group">
                <div class="editing-form-value-cell editing-form-value-cell-offset">
                    <cms:LocalizedButton runat="server" ID="btnRefresh" ResourceString="ObjectBrowser.LoadExpression"
                        OnClick="btnRefresh_Click" ButtonStyle="Primary" />
