...
<div id="<%=ClientID%>" class="unigrid dont-check-changes">
    ...
    <asp:Panel ID="pnlContent" runat="server" CssClass="unigrid-content">
        <cms:UIGridView ID="UniUiGridView" ShortID="v" runat="server" AllowPaging="True" PageSize="25"
            AutoGenerateColumns="False" AllowSorting="true" OnSorting="UniGridView_Sorting"
            OnRowCreated="UniGridView_RowCreating" OnDataBound="UniGridView_DataBound">
