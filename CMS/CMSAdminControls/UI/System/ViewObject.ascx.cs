...
public partial class CMSAdminControls_UI_System_ViewObject : CMSAdminEditControl
{
    ...
    {
        pnlContent.Controls.Add(new LiteralControl("<div class='form-group'><div class='editing-form-label-cell'><span class='control-label'>Object type:</span></div><div class='editing-form-value-cell'><span class='form-control-text'>" + objectType + "</span></div></div>"));
    }
