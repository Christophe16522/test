...
<%@ Register TagPrefix="asp" Namespace="CMS.ExtendedControls" Assembly="CMS.ExtendedControls, Version=8.0.0.0, Culture=neutral, PublicKeyToken=834b12a258f213f9" %>
    ...
    <cms:CMSUpdatePanel runat="server" ID="pnlUpdate" UpdateMode="Always">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlAll" runat="server" CssClass="header-panel btn-actions" Visible="false" EnableViewState="false">
                <asp:LocalizedButton runat="server" ID="lnkSelectAll" OnClick="lnkSelectAll_Click" ButtonStyle="Default" />
                <asp:LocalizedButton runat="server" ID="lnkDeselectAll" OnClick="lnkDeselectAll_Click" ButtonStyle="Default" />
            </asp:Panel>
