...
<div id="<%=ClientID%>" class="UniFlatSelector">
    ...
    <asp:Panel runat="server" ID="pnlSearch" CssClass="uni-flat-search-panel form-horizontal" DefaultButton="btnSearch">
        <div class="form-horizontal form-filter">
            <div class="form-group">
                <div class="control-group-inline">
                    ...
                    <cms:CMSTextBox runat="server" ID="txtSearch" MaxLength="200" />
                    <cms:CMSAccessibleButton runat="server" ID="btnSearch" ResourceString="general.search"
                        OnClick="btnSearch_Click" CssClass="btn-flat-search" EnableViewState="false" IconOnly="True" IconCssClass="icon-magnifier"/>
