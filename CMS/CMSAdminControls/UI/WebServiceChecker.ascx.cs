...
public partial class CMSAdminControls_UI_WebServiceChecker : CMSUserControl, IPostBackEventHandler
{
    ...
    /// </summary>
    private const string HELP_TOPIC_CONFIGURING_WCF_LINK = "WIA8";
    ...
    public string NotFoundText
    {
        get
        {
            string link = String.Format("<a target=\"_blank\" href=\"{0}\">{1}</a>", UIContextHelper.GetDocumentationTopicUrl(HELP_TOPIC_CONFIGURING_WCF_LINK), GetString("general.ourdocumentation"));
    ...
    public string ServerErrorText
    {
        get
        {
            string link = String.Format("<a target=\"_blank\" href=\"{0}\">{1}</a>", UIContextHelper.GetDocumentationTopicUrl(HELP_TOPIC_CONFIGURING_WCF_HTTPS_LINK), GetString("general.ourdocumentation"));
