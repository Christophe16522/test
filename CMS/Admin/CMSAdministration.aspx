                ...
                <cms:BasicUniView runat="server" ID="appListUniview" HierarchicalDisplayMode="Inner" RelationColumnID="ElementID" DataBindByDefault="False" EnableViewState="False">
                    <ItemTemplate>
                        <asp:PlaceHolder runat="server" ID="plcCategoryTemplate" Visible="false">
                            <div class="panel panel-default js-filter-parent">
                                <div class="panel-heading">
                                    <h3><span class="accordion-toggle" data-toggle="collapse" data-parent="#cms-applist" data-target="#collapse<%# Eval("ElementID") %>"><%# Eval("ElementDisplayName") %></span></h3>
                                </div>
                        ...
                        <asp:PlaceHolder runat="server" ID="plcItemTemplate" Visible="False">
                            <li class="js-filter-item" title="<%# ResHelper.LocalizeString(Eval("ElementDescription").ToString()) %>"><a href="#<%# Eval("ElementGUID")%>" data-appguid="<%# Eval("ElementGUID")%>"><%# UIHelper.GetAccessibleImageMarkup(Page, EvalText("ElementIconClass", "icon-app-default"), EvalText("ElementIconPath"), size: FontIconSizeEnum.Standard, iconColorClass: ApplicationHelper.GetApplicationIconCssClass(EvalGuid("ElementGUID"))) %>
                                <%# Eval("ElementDisplayName") %></a></li>
                        </asp:PlaceHolder>
                    </ItemTemplate>
                </cms:BasicUniView>
