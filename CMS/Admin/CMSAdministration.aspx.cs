...
public partial class Admin_CMSAdministration : CMSDeskPage
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        ScriptHelper.RegisterModule(Page, "CMS/AppList", new
        {
            ...
            defaultAppUrl = URLHelper.ResolveUrl("~/CMSModules/Admin/Dashboard.aspx"),
        ...
        ScriptHelper.RegisterBootstrapTooltip(Page, ".js-filter-item", "<div class=\"tooltip applist-tooltip\"><div class=\"tooltip-arrow\"></div><div class=\"tooltip-inner\"></div></div>");
    }
